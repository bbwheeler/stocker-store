...
1. Make sure all existing changes have been checked in; if there are existing changes not part of your current task, check them in and push them to the remote.
